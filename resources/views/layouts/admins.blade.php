                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="li-menus"><a><i class="fa fa-wrench"></i> Users <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="{!! route('users_add') !!}">Add</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="li-menus"><a><i class="fa fa-wrench"></i> Company <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="{!! route('companies_view') !!}">View Company</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="li-menus"><a><i class="fa fa-list-alt"></i> Resources <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="{!! route('resources_edit') !!}">Manage Resources</a>
                                        </li>
                                    </ul>
                                </li>
